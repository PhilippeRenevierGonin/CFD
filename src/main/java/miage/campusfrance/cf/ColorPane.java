...
/**
 * source : https://stackoverflow.com/questions/6899282/ansi-colors-in-java-swing-text-fields
 */
public class ColorPane extends JTextPane {
    static final Color D_Black   = Color.getHSBColor( 0.000f, 0.000f, 0.000f );
    static final Color D_Red     = new Color(255,96,96) ; // Color.getHSBColor( 0.000f, 1.000f, 0.502f );
    ...
    static final Color D_Green   = Color.GREEN; // Color.getHSBColor( 0.333f, 1.000f, 0.502f );
    static final Color D_Yellow  = Color.ORANGE; // Color.getHSBColor( 0.167f, 1.000f, 0.502f );
    ...
    static final Color B_Red     = new Color(255,192,192); // Color.getHSBColor( 0.000f, 1.000f, 1.000f );
    ...
    public void append(Color c, String s) {
        ...
        /*
        try {getDocument().insertString(len, s+"\n", aset);}
...
// now we have the color, send text that is in that color (up to next escape)
    ...
    public Color getANSIColor(String ANSIColor) {
        ...
        else if (ANSIColor.equals("\u001B[40m"))        { return D_Black; }
        else if (ANSIColor.equals("\u001B[41m"))   { return D_Red; }
        else if (ANSIColor.equals("\u001B[42m"))   { return D_Green; }
        else if (ANSIColor.equals("\u001B[43m"))   { return D_Yellow; }
        else if (ANSIColor.equals("\u001B[44m"))   { return D_Blue; }
        else if (ANSIColor.equals("\u001B[45m"))   { return D_Magenta; }
        else if (ANSIColor.equals("\u001B[46m"))   { return D_Cyan; }
        else if (ANSIColor.equals("\u001B[47m"))   { return D_White; }
